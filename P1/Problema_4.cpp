...
int main() {
    ...
    while (true) {
        ...
        if (hora >= 0 && hora <= 23 && minuto >= 0 && minuto <= 59) {
            ...
            std::cout << hora_inicial << " es un tiempo invalido. Inténtalo de nuevo." << std::endl;
        }
    }

    // Bucle para pedir la duración hasta que sea válida
    while (true) {
        std::cout << "Ingrese la duración (formato hhmm): ";
        std::cin >> duracion;
        ...
        if (horas_duracion >= 0 && minutos_duracion >= 0 && minutos_duracion <= 59) {
            ...
            std::cout << duracion << " es un tiempo invalido. Inténtalo de nuevo." << std::endl;
        }
    }
    ...
    nuevo_minuto %= 60; // Ajustar minutos al rango 0-59
